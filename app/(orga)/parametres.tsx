...
export default function ParametresOrgaScreen() {
  ...
  const handleDeleteAccount = () => {
    Alert.alert(
      ...
      'Cette action est irréversible. Tous tes events et données seront supprimés.',
      [
    ...
    <SafeAreaView style={s.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
        ...
        <View style={s.card}>
          ...
          <View style={s.fieldRow}>
            <View style={[s.fieldIcon, { backgroundColor: 'rgba(255,193,7,0.1)' }]}>
              <Text style={s.fieldEmoji}>🏢</Text>
            </View>
            <View style={s.fieldContent}>
              <Text style={s.fieldLabel}>SIRET (optionnel)</Text>
              <TextInput
                style={s.fieldInput}
                value={siret}
        ...
        <View style={s.card}>
          <View style={s.switchRow}>
            ...
            <Text style={s.switchLabel}>Nouvelles réservations</Text>
            <Switch
              value={notifResa}
          ...
          <View style={s.switchRow}>
            ...
            <Text style={s.switchLabel}>Alertes places restantes</Text>
            <Switch
              value={notifAlerte}
              onValueChange={setNotifAlerte}
              trackColor={{ false: 'rgba(255,255,255,0.1)', true: Colors.purple }}
              thumbColor="#fff"
            />
          </View>
